    ...
    <div class="row">
        <div class="col-lg-6 form-group">
            ...
            <input class="form-control text-box single-line" data-val="true"
                ...
                name="first_name" placeholder="First Name" required="required" type="text" value="{{ $user->first_name }}" />
        ...
        <div class="col-lg-6 form-group">
            ...
            <input class="form-control text-box single-line" data-val="true"
                ...
                name="last_name" placeholder="Last Name" required="required" type="text" value="{{ $user->last_name }}" />
    ...
    <div class="row">
        <div class="col-lg-6 form-group">
            ...
            <input class="form-control text-box single-line" data-val="true"
                ...
                name="phone_no" placeholder="Phone Number" required="required" type="text" value="{{ $user->phone_no }}" />
    ...
    <div class="row">
        <div class="col-lg-6 form-group">
            ...
            <input class="form-control text-box single-line" data-val="true"
                ...
                data-val-maxlength-max="30" id="Address" name="address" placeholder="Address" type="text" value="{{ $user->address }}" />
